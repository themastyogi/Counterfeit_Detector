...
import { User, Mail, Lock, ArrowRight, AlertCircle, CheckCircle, Shield } from 'lucide-react';
      ...
      <div className="max-w-md w-full space-y-8 bg-surface p-8 rounded-2xl shadow-premium-lg border border-border">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-text-muted">
            Join VeriScan for advanced detection
          </p>
        </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          <div className="space-y-4">
            <div>
              <label htmlFor="fullName" className="block text-sm font-medium text-text-main mb-1">
                Full Name
              </label>
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-lg text-white bg-primary hover:bg-primary-light focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary disabled:opacity-70 transition-all duration-200 shadow-lg hover:shadow-xl mt-6"
          >
            {isLoading ? (
              ...
              <span className="absolute left-0 inset-y-0 flex items-center pl-3">
                <ArrowRight className="h-5 w-5 text-emerald-300 group-hover:text-emerald-200" aria-hidden="true" />
              </span>
            )}
