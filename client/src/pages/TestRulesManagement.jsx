                    ...
                    <div className="card p-4 h-96 flex flex-col">
                        ...
                        <div className="flex-1 overflow-y-auto space-y-2 pr-2">
                            {products.map(product => {
                                // Find default profile for this product
                                const defaultProfile = profiles.find(p => p.product_id === product._id && p.is_default);
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        {defaultProfile && (
                                            <div className="text-[10px] mt-1 text-indigo-600 flex items-center gap-1">
                                                <FileText size={10} />
